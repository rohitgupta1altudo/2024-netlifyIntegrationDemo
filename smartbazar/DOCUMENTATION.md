...
1. [SmartBazaar Shop](https://retail-bazaar.vercel.app)
2. [SmartBazaar Admin](https://smart-bazar-admin.vercel.app)
3. [SmartBazaar API](https://smart-bazar-api.vercel.app/docs)
...
## Admin Dashboard (GraphQL) - not used
...
**NOTE** : This will start the server at `http://localhost:5001/api/` for rest api and you can access it from browser at `http://localhost:5001/docs`(for rest swagger doc).

<br>

## Admin(GraphQL) - not used
