...
import StyleguideSpecimen from '@/core/atoms/styleguide/Styleguide-Specimen';
 ...
 */
const StyleguideFieldUsageItemLink = (
  props: StyleguideFieldUsageItemLinkProps
): JSX.Element => {
      ...
      */}
      {sharedItemLink && (
        <div>
          ...
          <p>
            Field:{' '}
            <Text field={sharedItemLink.fields.textField as Field<string>} />
          </p>
        </div>
      )}
      ...
      {localItemLink && (
        <div>
          <p>
            Field:{' '}
            <Text field={localItemLink.fields.textField as Field<string>} />
          </p>
        </div>
      )}
    </StyleguideSpecimen>
