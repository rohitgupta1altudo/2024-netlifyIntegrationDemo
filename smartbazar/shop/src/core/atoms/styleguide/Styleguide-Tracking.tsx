...
type StyleguideTrackingProps = ComponentWithContextProps &
...
class StyleguideTracking extends React.Component<StyleguideTrackingProps> {
  ...
  render() {
    const disconnectedMode =
      this.props.sitecoreContext.itemId === 'available-in-connected-mode';

    return (
      <StyleguideSpecimen {...this.props} e2eId="styleguide-tracking">
        {disconnectedMode && (
          <p>
            The tracking API is only available in connected, integrated, or
            headless modes.
          </p>
        )}
        {!disconnectedMode && (
          <div>
            ...
            <div className="row">
              ...
              <fieldset className="form-group col-sm">
                ...
                <p>
                  ...
                  single request. This can be useful for queuing strategies or
                  offline PWA usage.
                </p>
                <button
                  type="button"
            ...
            <div className="row">
              <fieldset className="form-group col-sm">
                ...
                <p>
                  Tracking data is not pushed into the xConnect service until
                  your session ends on the Sitecore server. Click this button to
                  instantly end your session and flush the data - great for
                  debugging and testing.
                </p>
                <p className="alert alert-warning">
                  Note: By default <em>anonymous</em> contacts will not be shown
                  in Experience Profile. If your interactions are not showing up
                  in Experience Profile, you may need to{' '}
