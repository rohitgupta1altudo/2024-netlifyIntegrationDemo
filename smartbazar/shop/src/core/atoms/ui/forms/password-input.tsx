...
import { EyeOff } from '@/core/atoms/icons/eye-off-icon';
      ...
      <div className={className}>
        ...
        <div className="relative">
          <input
            ...
            ref={ref}
            className={cn(
              'w-full appearance-none rounded py-3 text-sm text-heading transition duration-300 ease-in-out focus:outline-none focus:ring-0 ltr:pl-4 ltr:pr-11 rtl:pr-4 rtl:pl-11',
              shadow && 'focus:shadow',
