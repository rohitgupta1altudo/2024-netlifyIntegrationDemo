import MobileCategoryMenu from '@/core/atoms/layouts/mobile-menu/mobile-category-menu';
import { drawerAtom } from '@/store/drawer-atom';
import { useAtom } from 'jotai';
import dynamic from 'next/dynamic';
import Drawer from './drawer';
const CartSidebarView = dynamic(
  () => import('@/core/atoms/cart/cart-sidebar-view')
);
const MobileAuthorizedMenu = dynamic(
  () => import('@/core/atoms/layouts/mobile-menu/mobile-authorized-menu')
);
const MobileMainMenu = dynamic(
  () => import('@/core/atoms/layouts/mobile-menu/mobile-main-menu')
);
const SearchFilterView = dynamic(
  () => import('@/core/atoms/search-view/sidebar-filter')
);
