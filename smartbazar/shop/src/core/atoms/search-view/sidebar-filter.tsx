import { CustomDisclosure } from '@/core/atoms/ui/disclosure';
import { useTranslation } from 'next-i18next';
import Search from '@/core/atoms/ui/search/search';
import { useRouter } from 'next/router';
import Sorting from './sorting';
import PriceFilter from '@/core/atoms/search-view/price-filter';
import CategoryFilter from '@/core/atoms/search-view/category-filter-view';
import TagFilter from '@/core/atoms/search-view/tag-filter-view';
import ManufacturerFilter from '@/core/atoms/search-view/manufacturer-filter-view';
import classNames from 'classnames';
import { useAtom } from 'jotai';
import { drawerAtom } from '@/store/drawer-atom';
import ArrowNarrowLeft from '@/core/atoms/icons/arrow-narrow-left';
