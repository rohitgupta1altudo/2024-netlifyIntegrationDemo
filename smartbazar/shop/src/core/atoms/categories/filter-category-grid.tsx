...
import CategoriesLoader from '@/core/atoms/ui/loaders/categories-loader';
import CategoryCard from '@/core/atoms/ui/category-card';
import { useRouter } from 'next/router';
import CategoryBreadcrumb from '@/core/atoms/ui/category-breadcrumb-card';
