...
import { NavbarIcon } from '@/core/atoms/icons/navbar-icon';
import { HomeIcon } from '@/core/atoms/icons/home-icon';
import { ShoppingBagIcon } from '@/core/atoms/icons/shopping-bag-icon';
import { UserIcon } from '@/core/atoms/icons/user-icon';
