import Loader from '@/core/atoms/ui/loaders/spinner/spinner';
import { useRouter } from 'next/router';
import { BackArrowRound } from '@/core/atoms/icons/back-arrow-round';
import { useUser } from '@/framework/user';
import LoginView from '@/core/atoms/auth/login-form';
